...
from pleiotropy.evolution.ocra.neat.config import ConfigParameter, DefaultClassConfig
from pleiotropy.evolution.ocra.neat.math_util import mean
...
class DefaultReproduction(DefaultClassConfig):
    ...
    def reproduce(self, config, species, pop_size, generation):
        ...
        for spawn, s in zip(spawn_amounts, remaining_species):
            ...
            # Forces at least 50% asexual reproduction
            while spawn > 0:
                spawn -= 2
        ...
        return new_population, num_sexual, num_asexual
